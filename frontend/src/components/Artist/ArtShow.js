      ...
      return (
        <section className="hero is-fullheight-with-navbar">
          <div className="hero-body">
            <div className="container artShowContainer">

              <div className="column auto">
              </div>

              <div className="column is-two-fifths artShowMain">
                <div className="artName artContent">
                  <h1 className="title">{this.state.art.name}</h1>
                </div>

                <div className="artContent">
                  <img className="image imgArtShow" src={this.state.art.image} alt={this.state.art.descripton}/>
                </div>
                <div className="artContent">
                  <h2>By {this.state.art.owner.username}</h2>
                </div>
                <div className="artContent columns">
              ...
              <div className="column is-one-fifth artShowEnquire">
                { isOwner ?
                  <div>
                    <p>Enquiries:</p>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" onClick={this.handleDelete} className="deleteIcon"><path d="M3 6v18h18v-18h-18zm5 14c0 .552-.448 1-1 1s-1-.448-1-1v-10c0-.552.448-1 1-1s1 .448 1 1v10zm5 0c0 .552-.448 1-1 1s-1-.448-1-1v-10c0-.552.448-1 1-1s1 .448 1 1v10zm5 0c0 .552-.448 1-1 1s-1-.448-1-1v-10c0-.552.448-1 1-1s1 .448 1 1v10zm4-18v2h-20v-2h5.711c.9 0 1.631-1.099 1.631-2h5.315c0 .901.73 2 1.631 2h5.712z"/></svg>
